...
class DataManager:
    ...
    def _initialize_data(self):
        ...
        self.add_agent(
            ...
            "+1-555-0101",
            "Luxury Homes",
            "Specializing in high-end residential properties with 10+ years experience",
        )
        self.add_agent(
            "Mike Chen",
            "mike.chen@realestate.com",
            "+1-555-0102",
        ...
        self.add_agent(
            "Lisa Rodriguez",
            "lisa.rodriguez@realestate.com",
            "+1-555-0103",
            "First-Time Buyers",
            "Dedicated to helping first-time homebuyers navigate the market",
        )
        ...
        self.add_property(
            ...
            "Central Air",
            None,
            "Granite Countertops, Hardwood Floors, City Views, Balcony",
            "Downtown",
            "residential",
            "sale",
        )
        ...
        self.add_property(
            ...
            "Central Air",
            None,
            "Updated Kitchen, Large Backyard, 3-Car Garage, Walk-in Closets",
            "Suburbia",
            "residential",
            "sale",
        )
        ...
        self.add_property(
            ...
            "Central Air",
            None,
            "Private Dock, Infinity Pool, Lake Views, Wine Cellar, Smart Home",
            "Waterfront",
            "residential",
            "sale",
        )
        ...
        self.add_property(
            "Urban Loft",
            "321 Industrial Blvd, Arts District",
            0,
            "Loft",
            1,
            1,
            ...
            "Window Units",
            None,
            "Exposed Brick, High Ceilings, Industrial Design, Artist Space",
            "Arts District",
            "residential",
            "rental",
            400000000,
        ...
        self.add_property(
            ...
            "Central Air",
            None,
            "Updated Appliances, New Roof, Fenced Yard, Quiet Street",
            "Neighborhood",
            "residential",
            "sale",
        )
        ...
        self.add_property(
            "Penthouse Suite",
            "100 Sky Tower, Downtown",
            875000,
            "Condo",
            3,
            3,
            2100,
            "Top floor penthouse with panoramic views",
            "active",
            1,
        )
        self.add_property(
            "Victorian Townhouse",
            "567 Heritage Lane, Historic District",
            525000,
            "Townhouse",
            3,
            2.5,
            1650,
            "Restored Victorian with modern amenities",
            "active",
            2,
        )
        self.add_property(
            "Ranch Style Home",
            "890 Country Road, Suburbs",
            335000,
            "House",
            3,
            2,
            1600,
            "Single story ranch on large lot",
            "active",
            3,
        )
        self.add_property(
            "Urban Loft",
            "45 Industrial Way, Arts District",
            395000,
            "Loft",
            1,
            1,
            1100,
            "Converted warehouse loft with exposed brick",
            "active",
            1,
        )
        self.add_property(
            "Garden Apartment",
            "234 Green Street, Westside",
            275000,
            "Condo",
            2,
            1.5,
        ...
        self.add_property(
            "Executive Home",
            "777 Executive Circle, Uptown",
            695000,
            "House",
            4,
            3.5,
            2800,
            "Executive home in gated community",
            "active",
            3,
        )
        self.add_property(
            "Beachfront Condo",
            "888 Ocean View, Coastal",
            620000,
            "Condo",
            2,
            2,
            1350,
            "Direct beach access with ocean views",
            "active",
            1,
        )
        self.add_property(
            "Affordable Starter",
            "999 Budget Lane, Eastside",
            165000,
            "House",
            2,
            1,
        ...
        self.add_property(
            "Commercial Space",
            "1010 Business Blvd, Commercial District",
            850000,
            "Commercial",
            0,
            2,
        ...
        self.add_task(
            ...
            "Call John about condo viewing feedback",
            1,
            "high",
        ...
        self.add_task(
            ...
            "Create detailed report for waterfront estate",
            1,
            "medium",
        ...
        self.add_task(
            ...
            "Coordinate inspection for Pine Street property",
            3,
            "high",
    ...
    def get_properties(
        ...
        if property_condition:
            properties = [
                p for p in properties if p.property_condition.lower() == property_condition.lower()
            ]

        if property_category:
            properties = [
                p for p in properties if p.property_category.lower() == property_category.lower()
            ]
    ...
    def get_dashboard_stats(self) -> dict:
        ...
        active_deals = len(
            [d for d in self.deals.values() if d.status not in ["closed_won", "closed_lost"]]
        )

        # Calculate total deal value
        total_deal_value = sum(
            deal.offer_amount for deal in self.deals.values() if deal.offer_amount > 0
        )
